...
namespace MQKJ.BSMP.Users
{
    ...
    public class UserAppService : AsyncCrudAppService<User, UserDto, long, PagedResultRequestDto, CreateUserDto, UserDto>, IUserAppService
    {
        ...
        public async Task<List<Company>> GetAllUserCompanies()
        {
            return await _companyRepository.GetAll().AsNoTracking().ToListAsync();
        }
        ...
        public override async Task<UserDto> Update(UserDto input)
        {
            ...
            if (input.CompanyId.HasValue && input.CompanyId.Value == -1)
            {
        ...
        [AbpAllowAnonymous]
        public async Task<bool> ModifyPasswordForTest(ModifyPasswordInput input)
        {
            ...
            {
                if (input.NewPassword == input.OldPassword&& input.OldPassword == "modifypassword123456") {
        ...
        public async Task ModifyPassword(ModifyPasswordInput input)
        {
            ...
            {
                if (string.IsNullOrEmpty(input.OldPassword) || string.IsNullOrWhiteSpace(input.OldPassword))
                {
