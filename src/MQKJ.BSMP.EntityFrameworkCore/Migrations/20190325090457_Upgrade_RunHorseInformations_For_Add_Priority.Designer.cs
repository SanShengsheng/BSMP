...
namespace MQKJ.BSMP.Migrations
{
    ...
    [Migration("20190325090457_Upgrade_RunHorseInformations_For_Add_Priority")]
    partial class Upgrade_RunHorseInformations_For_Add_Priority
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MQKJ.BSMP.ChineseBabies.Athletics.AthleticsReward", b =>
                {
                    ...
                    b.Property<int>("ChineseBabyMarketId");
                    ...
                    b.Property<int>("MaxRanking");

                    b.Property<int>("MinRanking");
            ...
            modelBuilder.Entity("MQKJ.BSMP.ChineseBabies.Backpack.BabyAssetAddition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<double>("ArenaWinRate");
                    ...
                    b.Property<int>("EventCD");

                    b.Property<double>("EventCoin");

                    b.Property<double>("EventEnergy");
                    ...
                    b.ToTable("BabyAssetAdditions");
                });

            modelBuilder.Entity("MQKJ.BSMP.ChineseBabies.Backpack.BabyAssetAdditionRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int>("BabyAssetAdditionId");

                    b.Property<Guid?>("BabyAssetAdditionId1");
                    ...
                    b.HasIndex("BabyAssetAdditionId1");

                    b.ToTable("BabyAssetAdditionRecords");
                });
            ...
            modelBuilder.Entity("MQKJ.BSMP.ChineseBabies.PropMall.BabyPropFeature", b =>
                {
                    ...
                    b.Property<int>("BabyPropFeatureTypeId");

                    b.Property<Guid?>("BabyPropFeatureTypeId1");
                    ...
                    b.HasIndex("BabyPropFeatureTypeId1");
            ...
            modelBuilder.Entity("MQKJ.BSMP.ChineseBabies.PropMall.BabyPropTerm", b =>
                {
                    ...
                    b.Property<int>("BabyPropBuyTermId");

                    b.Property<Guid?>("BabyPropBuyTermId1");
            ...
            modelBuilder.Entity("MQKJ.BSMP.Common.RunHorseInformations.RunHorseInformation", b =>
                {
                    ...
                    b.Property<DateTime?>("EndTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2119, 3, 25, 17, 4, 55, 599, DateTimeKind.Local));
            ...
            modelBuilder.Entity("MQKJ.BSMP.ChineseBabies.BabyProp", b =>
                {
                    b.HasOne("MQKJ.BSMP.ChineseBabies.Reward", "Addition")
                        .WithMany()
            ...
            modelBuilder.Entity("MQKJ.BSMP.ChineseBabies.Backpack.BabyAssetAdditionRecord", b =>
                {
                    b.HasOne("MQKJ.BSMP.ChineseBabies.Backpack.BabyAssetAddition", "BabyAssetAddition")
                        .WithMany("BabyAssetAdditionRecords")
                        .HasForeignKey("BabyAssetAdditionId1");
                });
            ...
            modelBuilder.Entity("MQKJ.BSMP.ChineseBabies.PropMall.BabyPropFeature", b =>
                {
                    b.HasOne("MQKJ.BSMP.ChineseBabies.BabyPropFeatureType", "BabyPropFeatureType")
                        .WithMany()
                        .HasForeignKey("BabyPropFeatureTypeId1");
            ...
            modelBuilder.Entity("MQKJ.BSMP.ChineseBabies.PropMall.BabyPropTerm", b =>
                {
                    b.HasOne("MQKJ.BSMP.ChineseBabies.BabyPropBuyTermType", "BabyPropBuyTerm")
                        .WithMany()
                        .HasForeignKey("BabyPropBuyTermId1");
