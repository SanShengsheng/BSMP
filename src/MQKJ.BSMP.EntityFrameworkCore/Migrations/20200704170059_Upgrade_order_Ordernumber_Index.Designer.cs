...
namespace MQKJ.BSMP.Migrations
{
    ...
    [Migration("20200704170059_Upgrade_order_Ordernumber_Index")]
    partial class Upgrade_order_Ordernumber_Index
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MQKJ.BSMP.ChineseBabies.BabyProp", b =>
                {
                    ...
                    b.Property<int?>("TriggerNextShowPropCode");
            ...
            modelBuilder.Entity("MQKJ.BSMP.ChineseBabies.Family", b =>
                {
                    ...
                    b.Property<double>("TotalSubsidyAmount");
            ...
            modelBuilder.Entity("MQKJ.BSMP.Common.AD.Adviertisement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("AdviertisementPlatform");

                    b.Property<int>("AdviertisementState");
                    ...
                    b.Property<string>("ExpandPath");

                    b.Property<string>("FixedImagePath");

                    b.Property<string>("InsertImagePath");
                    ...
                    b.Property<string>("MinPorgramLogo");

                    b.Property<string>("MinPorgramQRPath");

                    b.Property<string>("Name");

                    b.Property<string>("OrderNumber");

                    b.Property<string>("PubLink");
                    ...
                    b.ToTable("Adviertisements");
                });

            modelBuilder.Entity("MQKJ.BSMP.Common.AD.PlayerAdviertisement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<int>("AdviertisementId");
                    ...
                    b.HasIndex("AdviertisementId");

                    b.HasIndex("PlayerId");

                    b.ToTable("PlayerAdviertisements");
                });

            modelBuilder.Entity("MQKJ.BSMP.Common.Companies.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MQKJ.BSMP.Common.WechatPay.WechatMerchant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MQKJ.BSMP.MqAgent", b =>
                {
                    ...
                    b.Property<string>("AliPayCardNO");
            ...
            modelBuilder.Entity("MQKJ.BSMP.Orders.Order", b =>
                {
                    ...
                    b.Property<int?>("WechatMerchantId");
            ...
            modelBuilder.Entity("MQKJ.BSMP.Authorization.Users.User", b =>
                {
                    b.HasOne("MQKJ.BSMP.Common.Companies.Company", "UserCompany")
                        .WithMany()
            ...
            modelBuilder.Entity("MQKJ.BSMP.Common.AD.PlayerAdviertisement", b =>
                {
                    b.HasOne("MQKJ.BSMP.Common.AD.Adviertisement", "Adviertisement")
                        .WithMany()
                        .HasForeignKey("AdviertisementId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("MQKJ.BSMP.MqAgent", b =>
                {
                    b.HasOne("MQKJ.BSMP.Common.Companies.Company", "Company")
                        .WithMany()
                        .HasForeignKey("CompanyId");
            ...
            modelBuilder.Entity("MQKJ.BSMP.Orders.Order", b =>
                {
                    ...
                    b.HasOne("MQKJ.BSMP.Common.WechatPay.WechatMerchant", "WechatMerchant")
                        .WithMany()
                        .HasForeignKey("WechatMerchantId");
                });
