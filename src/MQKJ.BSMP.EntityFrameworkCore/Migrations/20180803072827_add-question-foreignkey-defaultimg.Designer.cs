...
namespace MQKJ.BSMP.Migrations
{
    ...
    [Migration("20180803072827_add-question-foreignkey-defaultimg")]
    partial class addquestionforeignkeydefaultimg
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MQKJ.BSMP.BonusPoints.BonusPoinEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MQKJ.BSMP.BonusPoints.BonusPoint", b =>
                {
                    ...
                    b.Property<string>("ExtensionFiled");
            ...
            modelBuilder.Entity("MQKJ.BSMP.GameTasks.AnswerQuestion", b =>
                {
                    ...
                    b.Property<string>("InviteeAnswer")
                        .HasMaxLength(300);

                    b.Property<string>("InviterAnswer")
                        .HasMaxLength(300);
            ...
            modelBuilder.Entity("MQKJ.BSMP.SceneManager.BSMPFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MQKJ.BSMP.SceneManager.Scene", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MQKJ.BSMP.SceneManager.SceneFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MQKJ.BSMP.SceneManager.SceneType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MQKJ.BSMP.BonusPoints.BonusPoint", b =>
                {
                    b.HasOne("MQKJ.BSMP.BonusPoints.BonusPoinEvent", "BonusPoinEvent")
                        .WithMany()
            ...
            modelBuilder.Entity("MQKJ.BSMP.Questions.Question", b =>
                {
                    ...
                    b.HasOne("MQKJ.BSMP.SceneManager.BSMPFile", "DefaultImg")
                        .WithMany("Questions")
                        .HasForeignKey("DefaultImgId");

                    b.HasOne("MQKJ.BSMP.SceneManager.Scene", "Scene")
                        .WithMany()
            ...
            modelBuilder.Entity("MQKJ.BSMP.SceneManager.Scene", b =>
                {
                    b.HasOne("MQKJ.BSMP.SceneManager.SceneType", "Type")
                        .WithMany()
            ...
            modelBuilder.Entity("MQKJ.BSMP.SceneManager.SceneFile", b =>
                {
                    b.HasOne("MQKJ.BSMP.SceneManager.BSMPFile", "File")
                        .WithOne("SceneFile")
                        .HasForeignKey("MQKJ.BSMP.SceneManager.SceneFile", "FileId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("MQKJ.BSMP.SceneManager.Scene", "Scene")
                        .WithOne("SceneFile")
                        .HasForeignKey("MQKJ.BSMP.SceneManager.SceneFile", "SceneId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
