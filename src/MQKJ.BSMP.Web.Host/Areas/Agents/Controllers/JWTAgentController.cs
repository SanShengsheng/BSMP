...
{
    [AbpAuthorize]
    public class JWTAgentController : AgentBaseController
    {
        ...
        public JWTAgentController(IMqAgentAppService mqAgentAppService
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        [HttpGet("GetOwnRuningWaterRecord")]
        public async Task<ApiResponseModel<PagedResultDto<GetMoneyDetailedListDto>>> GetOwnRuningWaterRecord_V2(GetMoneyDetailedInput input)
        {
            var agentId = AbpSessionExternal.GetClaimValue(ExternalJwtRegisteredClaimNames.AgentId);
            input.AgentId = Convert.ToInt32(agentId);
            return await this.ApiTaskFunc(_mqAgentAppService.GetOwnRuningWaterRecord(input));
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        [HttpGet("GetAgentOrPromoterRuningWaterRecord")]
        public async Task<ApiResponseModel<PagedResultDto<GetMoneyDetailedListDto>>> GetAgentRuningWaterRecord_V2(GetMoneyDetailedInput input)
        {
            var agentId = AbpSessionExternal.GetClaimValue(ExternalJwtRegisteredClaimNames.AgentId);
            input.AgentId = Convert.ToInt32(agentId);
            return await this.ApiTaskFunc(_mqAgentAppService.GetAgentOrPromoterRuningWaterRecord(input));
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        [HttpGet("GetMessageCode")]
        public async Task<ApiResponseModel<bool>> GetMessageCode_V2(GetVerificationCodeInput input)
        {
            return await this.ApiTaskFunc(_mqAgentAppService.GetVerificationCode(input));
        }
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        [HttpGet("GetAgentInfo")]
        public async Task<ApiResponseModel<GetAgentInfoOutput>> GetAgentInfo_V2(GetAgentInfoInput input)
        {
            var agentId = AbpSessionExternal.GetClaimValue(ExternalJwtRegisteredClaimNames.AgentId);
            input.AgentId = Convert.ToInt32(agentId);
            return await this.ApiTaskFunc(_mqAgentAppService.GetAgentInfo(input));
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        [HttpGet("GetFamilyInfo")]
        public async Task<ApiResponseModel<GetFamilyInfoOutput>> GetFamilyInfo_V2(GetFamilyInfoInput input)
        {
        ...
        public async Task<ApiResponseModel<RequestWithdrawMoneyOutput>> RequestWithdrawMoney([FromBody]RequestWithdrawMoneyInput input)
        {
            var agentId = AbpSessionExternal.GetClaimValue(ExternalJwtRegisteredClaimNames.AgentId);
            var agentIdInt = 0;
            if (int.TryParse(agentId,out agentIdInt))
            {
                input.AgentId = agentIdInt;
            }
        ...
        {
            var s = AbpSessionExternal.GetClaimValue(ExternalJwtRegisteredClaimNames.PlayerId);
