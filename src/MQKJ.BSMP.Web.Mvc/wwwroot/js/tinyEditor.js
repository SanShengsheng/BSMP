// 使用步骤，在需要绑定的textarea添加background-story样式
function IniTinyMCE(selector) {
            tinymce.init({
                selector: selector,
               language: 'zh_CN',
                indentation: '2em',
                ...
                plugins: [
                    'powerpaste,preview,searchreplace,code,wordcount',
                    'textcolor help'
                ],
                toolbar1: "undo redo| searchreplace |  formatselect | bold italic backcolor  | alignleft  | bullist numlist outdent indent | removeformat | code | help",
